...
class _RecentJobPostState extends State<RecentJobPost> {
  ...
  Future<void> _fetchFavoriteStatus() async {
    bool isFavorite =
    await FavoriteService.checkIfFavorite(SessionManager.userModel!.id,widget.jobPostModel.id);
                ...
                child: ValueListenableBuilder(
                    ...
                    builder: (context, value, child) {
                      return InkWell(
                        ...
                        child: Icon(Icons.favorite, color: isAlreadySelected.value
                            ? Colors.blue
                            : Colors.grey,),
  ...
  Future<void> _toggleFavorite() async {
    ...
    bool isAlreadyFavorite = await FavoriteService.checkIfFavorite(SessionManager.userModel!.id,widget.jobPostModel.id);
    ...
    if (isAlreadySelected.value && !isAlreadyFavorite) {
      ...
      await FavoriteService.addToFavorites(SessionManager.userModel!.id,widget.jobPostModel.id);
      print("Added to Favorites");
    } else if (!isAlreadySelected.value && isAlreadyFavorite) {
      // If the post is already in favorites, remove it
      await FavoriteService.removeFromFavorites(SessionManager.userModel!.id,widget.jobPostModel.id);
