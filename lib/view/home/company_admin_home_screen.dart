...
class _CompanyAdminHomeScreenState extends State<CompanyAdminHomeScreen> {
            ...
            child: Scaffold(
              ...
              body: (SessionManager.companyModel!.status
                  ...
                  : (SessionManager.companyModel!.status
                              ...
                              .last ==
                          'Disabled')
                      ? _disableState(context)
                      : _suspendedState(context),
            ),
          ),
        ],
      ),
  ...
  Center _suspendedState(BuildContext context) {
    return Center(
      child: Column(
  ...
  Center _disableState(BuildContext context) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          ...
          return AdminDashboardCard(
              ...
              onTap: () {
                if (index == 0) {
                  ...
                  Utils.navigateTo(
                      context,
                      CompanyAdminProfileScreen(
                        role: "Company Admin",
                        companyModel: SessionManager.companyModel,
                      ));
                } else if (index == 3) {
                  Utils.navigateTo(
                      context, const CompanyAdminAllApplicationScreen());
                } else {
                  null;
                }
              });
