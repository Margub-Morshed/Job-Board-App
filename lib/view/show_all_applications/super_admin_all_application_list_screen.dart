...
class SuperAdminAllApplicationScreen extends StatefulWidget {
  const SuperAdminAllApplicationScreen({super.key,});
  @override
  State<SuperAdminAllApplicationScreen> createState() => _SuperAdminAllApplicationScreenState();
}

class _SuperAdminAllApplicationScreenState extends State<SuperAdminAllApplicationScreen> {
  ...
  Widget build(BuildContext context) {
    return Hero(
      ...
      child: Container(
        ...
        child: ClipRRect(
          borderRadius: BorderRadius.circular(12),
          child: (imageUrl!.isNotEmpty || imageUrl == null) ? CachedNetworkImage(
